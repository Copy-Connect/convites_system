  ...
  <main class="wrap">
    <section class="card">
      ...
      <div v-if="details" class="meta">
        ...
        <p v-if="details.updatedAt">
          <b>Atualizado:</b> {{ new Date(details.updatedAt).toLocaleString() }}
        </p>
      </div>
      <p class="hint">
        Você pode fechar esta página; avisaremos dentro do app quando o pagamento confirmar.
      </p>
    </section>
  </main>
</template>
